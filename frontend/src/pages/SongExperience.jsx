...
export default function SongExperience() {
  ...
  return <div className="page-stack">
    ...
    <section className="song-experience-grid">
      <SectionCard className="song-media-card" title="Song Media">{song.videoUrl ? <div className="song-video-player"><video className="video-frame" controls playsInline poster={song.coverImageUrl || undefined} src={song.videoUrl} /></div> : song.coverImageUrl ? <img alt={`${song.title} cover`} className="video-frame video-frame--cover" src={song.coverImageUrl} /> : <p>Video and cover media are unavailable.</p>}</SectionCard>
